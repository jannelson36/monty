...
* [Ubuntu 22.04 LTS](http://releases.ubuntu.com/22.04/) - Operating system reqd.

* [GCC 12.2](https://gcc.gnu.org/gcc-12/) - Compiler used
...
```
$ git clone https://github.com/jannelson36/monty.git
```
